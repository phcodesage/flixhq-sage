...
export default function AdsterraBanner({ className = '' }: AdsterraBannerProps) {
  const iframeHtml = `
    ...
    <html>
      ...
      <body>
        <div id="container-593c9b3f5f9aca7f4f5602681b3d5b4e">
        ...
        <script async="async" data-cfasync="false" src="https://pl30566417.effectivecpmnetwork.com/593c9b3f5f9aca7f4f5602681b3d5b4e/invoke.js"></script>
      </body>
    </html>
  `;
